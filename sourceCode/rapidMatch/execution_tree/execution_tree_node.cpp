...
bool no_partition_hash_join_node::execute_operator(std::vector<flat_relation *> &relations, size_t& call_cnt,
                                                   size_t& embedding_cnt, int64_t& time_limit) {
    bool overtime = nop_join_->execute(call_cnt, embedding_cnt, time_limit);
...
bool leap_frog_trie_join_node::execute_operator(std::vector<flat_relation *> &relations, size_t& call_cnt,
                                                size_t& embedding_cnt, int64_t& time_limit) {
    bool overtime = lftj_->execute(call_cnt, embedding_cnt, time_limit);
